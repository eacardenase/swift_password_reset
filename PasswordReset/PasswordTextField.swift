...
class PasswordTextField: UIView {
    ...
    typealias CustomValidator = (_ textValue: String?) -> (
...
extension PasswordTextField: UITextFieldDelegate {
    ...
    func textField(
        ...
        let replacementStringHasWhiteSpace = string.rangeOfCharacter(
            from: CharacterSet.whitespaces
        )

        return replacementStringHasWhiteSpace == nil
    }
...
extension PasswordTextField {
    ...
    func validate() -> Bool {
        if let customValidator = customValidator,
            ...
            !customValidatorResult.isValid
        {
            showError(with: customValidatorResult.message)
